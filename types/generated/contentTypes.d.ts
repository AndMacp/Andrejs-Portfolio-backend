...
export interface ApiAboutMeAboutMe extends Struct.SingleTypeSchema {
  ...
  attributes: {
    CodeSnippet: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    ExperianceSlogan1: Schema.Attribute.String & Schema.Attribute.Required;
    ExperianceSlogan2: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiExperianceExperiance extends Struct.CollectionTypeSchema {
  collectionName: 'experiances';
  info: {
    description: '';
    displayName: 'Experiance';
    pluralName: 'experiances';
    singularName: 'experiance';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    JobTimeFrame: Schema.Attribute.String;
    JobTitle: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::experiance.experiance'
    > &
      Schema.Attribute.Private;
    PositionDescription1: Schema.Attribute.Text;
    PositionDescription2: Schema.Attribute.Text;
    PositionDescription3: Schema.Attribute.Text;
    PositionDescription4: Schema.Attribute.Text;
    PositionDescription5: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::experiance.experiance': ApiExperianceExperiance;
